...
export const socialMediaProfiles = [
  { title: 'Facebook', href: 'https://www.facebook.com/profile.php?id=100093195656405', icon: FacebookIcon },
  { title: 'Instagram', href: 'https://www.instagram.com/devluxe_/', icon: InstagramIcon },
]
